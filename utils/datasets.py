...
try:
    ...
    def _missing_torchvision(*args, **kwargs):
        raise RuntimeError("torchvision 扩展不可用，当前功能无法执行") from _TORCHVISION_IMPORT_ERROR

    save_image = _missing_torchvision
    roi_pool = _missing_torchvision
    roi_align = _missing_torchvision
    ps_roi_pool = _missing_torchvision
    ps_roi_align = _missing_torchvision
